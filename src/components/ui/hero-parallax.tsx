  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="[mask-image:linear-gradient(to_right,transparent,white_10%,white_70%,transparent)]"
      >
  ...
  return (
    <div className="max-w-7xl text-white relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        ...
        As a passionate developer and designer, I love crafting amazing and
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white scroll-m-20 pb-3 text-3xl font-semibold tracking-tight first:mt-0">
        {product.title}
      </h2>
    </motion.div>
  );
