...
const DATA = {
  navbar: [
    ...
    { href: "/article", icon: Newspaper, label: "Article" }, // Changed from PencilIcon to Newspaper
  ],
  contact: {
    social: {
      GitHub: {
      ...
      Instagram: {
        // Changed from Email to Instagram
        name: "Instagram",
        url: "https://www.instagram.com/mochrks/", // Updated URL
