    ...
    <div className="relative h-screen w-screen flex overflow-hidden flex-col items-center justify-center bg-gradient-to-br from-gray-800 to-slate-900">
      ...
      >
        <motion.div
          ...
          animate={{
            filter: isHovering ? ["hue-rotate(0deg)", "hue-rotate(360deg)"] : "hue-rotate(0deg)",
          }}
          transition={{
      ...
      <motion.div
        className="absolute pt-[120px] text-center overflow-hidden"
        animate={{ opacity: isEntering ? 0 : 1 }}
        transition={{ duration: 0.5 }}
      >
        <Button className="text-xl" onClick={() => setIsEntering(true)} variant="link">
          Go to Home
        </Button>
        <p className="text-sm mb-8 text-white">
          The page you're looking for has a broken connection
        </p>
      </motion.div>
